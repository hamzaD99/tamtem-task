  ...
  <div>
    <v-container fluid style="padding: 70px;">
      ...
      <v-row v-else justify="center">
        ...
        <v-col style="border-radius: 3%;box-shadow: rgba(0, 0, 0, 0.06) 0px 0px 20px 0px" cols="11" class="d-flex pa-0">
          <v-img cover style="border-radius: 3%;box-shadow: rgba(0, 0, 0, 0.02) 20px 5px 20px 0px":src="product.image ? getBlob(product.image) :require('@/assets/default-item.jpg')" max-width="50%"/>
          <div style="padding: 70px;" class="d-flex flex-column justify-space-evenly">
            ...
            <div style="background-color: rgb(48 114 66); width: 70%;color: white; padding: 20px;border-radius: 500px;text-align: center;font-size: 25px;margin-top: 30px;" class="mb-3">CTA</div>
          </div>
        </v-col>
